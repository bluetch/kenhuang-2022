...
import { H1, H2, H3, H4, H6, Container, Gallery, Layout } from "components";
    ...
    <Layout title="About | Ken Huang">
      <Container>
        <div className="grid grid-cols-5 gap-8 my-32">
          <Image src={portrait} alt="Ken Huang" className="p-8 col-span-2" />
              ...
              return (
                <div key={job.company} className="flex p-4 hover:bg-gray-100 hover:rounded-lg">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mb-4">{job.position} <span className="font-light">| {job.duration}</span></p>
