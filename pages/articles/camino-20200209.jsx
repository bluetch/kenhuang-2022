      ...
      <Container className="mt-20">
        ...
        <div className="py-8">
          <div className="mx-auto max-w-3xl space-y-8 text-gray-600 leading-relaxed">
            ...
            <p>途中也遇到少見的頁岩步道，岩片密度高又滑，整隻鞋子很難穩穩踩實，幸好有登山杖輔助，才不至於太狼狽。這條路感覺有意無意在提醒我：即使是看似平緩的日子，也隨時可能需要多一點耐心與調整。</p>
            <img
            ...
            <p>突然又想起在火車站那位老先生，思考 Who Am I? 這個問題，對有些人來說很簡單，但我就是想不到我有什麼特別的，值得拿出來說嘴的，儘管如此，奇妙的是對於出發前的各種焦慮好像隨著步行撒在路邊的石子裡消失不見。</p>
